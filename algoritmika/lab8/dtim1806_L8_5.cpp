...
//8. labor 5. feladat
//kruskallal irjuk ki egy graf osszefuggo komponenseit

#include <stdio.h>

main() {
	FILE*f = fopen("dtim1806_L8_5.txt", "r");
	...
	for (i = max; i > 0; i--) {										//ezt a kiiratast nemtudom hogy kene, hogy az "ures" komponenseket ne irja ki
